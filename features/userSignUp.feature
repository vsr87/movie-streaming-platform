...
Scenario: Cadastro bem sucedido com Verificação de E-mail 
    ...
    And eu preencho o campo "E-mail" com "exemplo@test.com"
    And eu preencho o campo "Senha" com "12345@aM"
    And eu preencho o campo "Confirmar Senha" com "12345@aM"
    And eu clico no botão "CRIAR CONTA"
    Then eu devo ver a tela pedindo para verificar o e-mail
...
Scenario: Cadastro mal sucedido via formulário
    ...
    And eu preencho o campo "Confirmar Senha" com "123456Ll"
    And eu clico no botão "CRIAR CONTA"
...
Scenario: Cadastro mal sucedido via formulário devido a senha inválida por tamanho
    ...
    When eu preencho o campo "Nome Completo" com "João"
    And eu preencho o campo "E-mail" com "exemplo@test.com"
    And eu preencho o campo "Senha" com "1234@aM"
    And eu preencho o campo "Confirmar Senha" com "1234@aM"
    And eu clico no botão "CRIAR CONTA"
